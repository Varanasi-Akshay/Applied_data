...
Reading the data and transforming them into same co-ordinate system so that they can be plotted together
```{r}
...
Removing any submerged land within 3miles from the coast and plotting them
```{r}
