RHODES_JOSHUA_HWK2_EIA <- function(year){
  ...
  f860 <- read.csv(paste('ME397_A2_data_csv/F860_', year, '.csv', sep = ''), stringsAsFactors = FALSE)
  ...
  f860.16 <- read.csv(paste('ME397_A2_data_csv/F860_', 2016, '.csv', sep = ''), stringsAsFactors = FALSE)
  ...
  f923 <- read.csv(paste('ME397_A2_data_csv/F923_', year, '.csv', sep = ''), stringsAsFactors = FALSE)
