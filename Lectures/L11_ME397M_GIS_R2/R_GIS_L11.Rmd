---
title: "L11 GIS in R2 shapefiles continued"
...
## get power plants 
pp2 <- shapefile('power_plant_shapefile/power_plant_shapefile.shp')
head(pp2)
```
...
## get the power plants that are within 10mi of a CO2 pipeline
d2 <- d_min[d_min < 16093] ## all distances are in meters!
...
```{r}
## make a range of point sizes to plot by
...
```{r}
## make colors for all the things
